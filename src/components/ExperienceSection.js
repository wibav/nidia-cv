...
export function ExperienceSection() {
    ...
    const formatDate = (dateString) => {
        ...
        return (
            <section id="experience" className="px-6 py-16 bg-gray-800">
    ...
    return (
        <section id="experience" className="px-6 py-16 bg-gray-800">
            <div className="max-w-5xl mx-auto">
                <h2 className="text-2xl font-semibold mb-6 text-center" style={{ color: theme.titleColor }}>Experiencia Profesional</h2>
                ...
                {experiences.length === 0 ? (
                    ...
                    <div className="space-y-6">
                        {experiences.map((exp) => (
                            <div key={exp.id} className="border-l-4 pl-6" style={{ borderColor: theme.titleColor }}>
                                <h3 className="text-xl font-semibold" style={{ color: theme.titleColor }}>{exp.position}</h3>
